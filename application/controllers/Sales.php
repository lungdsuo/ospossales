...
class Sales extends Secure_Controller
{
	...
	public function complete()
	{
		...
		elseif($this->sale_lib->is_wselect_customeork_order_mode())
		{
	...
	public function completewithoutgst()
	{
		$sale_id = $this->sale_lib->get_sale_id();
		$sale_type = $this->sale_lib->get_sale_type();
		$data = array();
		...
		if($this->sale_lib->is_invoice_mode() || $pos_invoice)
		{
			...
			else
			{
				...
				{
					$data['barcode'] = $this->barcode_lib->generate_receipt_barcode($data['sale_id']);
					$this->load->view('sales/invoicewithoutgst', $data);
					$this->sale_lib->clear_all();
				}
			}
		}
	...
	public function invoicewithoutgst($sale_id)
	{
		$data = $this->_load_sale_data($sale_id);
		$this->load->view('sales/invoicewithoutgst', $data);
		$this->sale_lib->clear_all();
