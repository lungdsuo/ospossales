...
<div id="page-wrap">
    ...
    <table id="items">
        ...
        <tr class="item-row">
            ...
            <td><textarea rows="4" cols="6"><?php //echo to_currency($item['price']);
                                                            	$tax_percent = $CI->sale_lib->get_tax_info_of_item($item['item_id']);
                                                            // $taxed_rate = $item['price'] * ($tax_percent * 0.01);
                                                            	$taxed_deducted_amount =(($item['price'] *100)/($tax_percent +100));
                                                            echo  to_currency($taxed_deducted_amount);
                                                            //echo $tax_percent;
            ...
            <td style='border-right: solid 1px; text-align:right;'><textarea rows="4"
                    cols="6"><?php echo to_currency($item['discounted_total']);
            //                                                                                                    echo to_currency($taxed_deducted_amount * $item['quantity']);
                                                                                                                ?></textarea>
            </td>
        </tr>
        <?php
