...
<div id="page-wrap">
    <div id="header"><?php echo $this->lang->line('sales_invoice');
						//echo "NON GST INVOICE";
						?></div>
    <div id="block1">
    ...
    <table id="items">
		...
		?>
        <!-- <tr>
				<td colspan="<?php //echo $invoice_columns-3; 
								?>" class="blank"> </td>
				<td colspan="2" class="total-line"><textarea rows="5" cols="6"><? php // echo $sales_tax['tax_group']; 
																				?></textarea></td>
				<td class="total-value"><textarea rows="5" cols="6" id="taxes"><? php // echo to_currency_tax($sales_tax['sale_tax_amount']); 
																				?></textarea></td>
			</tr> -->
        <?php
		/* } */
