		...
		?>
			...
			<?php echo form_open($controller_name."/cancel", array('id'=>'buttons_form')); ?>
				<div class="form-group" id="buttons_sale">
					...
					{
					?>
						<div class='btn btn-sm btn-success' id='finish_invoice_quote_button'><span class="glyphicon glyphicon-ok">&nbsp</span><?php //echo //$mode_label;
						echo "GST Invoice "; ?></div>
						<div class='btn btn-sm btn-success' id='finish_invoice_quote_button2'><span class="glyphicon glyphicon-ok">&nbsp</span><?php //echo $mode_label; 
						echo "Non GST Invoice";?></div>
					<?php
					}
					?>
...
$(document).ready(function()
{
	...
	$("#finish_invoice_quote_button2").click(function()
	{
		$('#buttons_form').attr('action', '<?php echo site_url($controller_name."/completewithoutgst"); ?>');
		$('#buttons_form').submit();
	});
